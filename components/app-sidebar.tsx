              ...
              {clinics.length > 1 ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="w-full flex items-center gap-2 px-3 py-2 rounded-lg bg-teal-600 hover:bg-teal-700 transition-colors text-left">
                      <Building2 className="h-3.5 w-3.5 text-teal-100 shrink-0" />
                ...
                <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-teal-600">
                  <Building2 className="h-3.5 w-3.5 text-teal-100 shrink-0" />
